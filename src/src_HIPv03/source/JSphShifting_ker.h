...
/// \file JSphShifting_ker.h \brief Declares functions and HIP kernels for Shifting correction on GPU.
...
/// Implements a set of functions and HIP kernels for Shifting correction on GPU.
namespace cushift{
