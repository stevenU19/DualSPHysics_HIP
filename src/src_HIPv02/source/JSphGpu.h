...
public:
  ///Structure that stores the block size to be used in each interaction kernel during GPU execution./ Estructura que almacena el tamaño del bloque que se utilizara en cada kernel de interaccion durante la ejecucion en GPU
  typedef struct {
