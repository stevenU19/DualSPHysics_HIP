...
/// \file JWaveOrder2_ker.h \brief Declares functions and HIP kernels for second order irregular wave generation.
...
/// Implements a set of functions and HIP kernels for second order irregular wave generation.
namespace cuwave2{
