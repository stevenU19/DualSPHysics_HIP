...
/// \file FunctionsBasic_iker.h \brief Implements basic functions for HIP files.

#include "TypesDef.h"
#include <hip/hip_runtime.h>

#ifndef SPHBSIZE
  #define SPHBSIZE 256  //-HIP blocksize by default.
#endif
...
//==============================================================================
// Returns gridsize according to parameters using X dimension.
// Devuelve los parámetros del tamaño de la cuadrícula según la dimensión X.
//==============================================================================
