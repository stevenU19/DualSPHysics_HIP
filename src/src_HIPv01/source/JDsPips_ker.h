...
/// \file JDsPips_ker.h \brief Declares functions and HIP kernels for PIPS calculation on GPU.
...
/// Implements a set of functions and HIP kernels for PIPS calculation.
namespace cupips{
