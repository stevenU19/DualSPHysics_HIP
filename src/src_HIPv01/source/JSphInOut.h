...
private:
  ...
  float MemoryResize0;    ///<Multiplier to calculate the minimum initial resize (default=2).
  float MemoryResize1;    ///<Multiplier to calculate the following resizes (default=4).
