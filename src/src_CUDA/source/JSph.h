...
protected:
  ...
  bool Symmetry;         ///<Activates symmetry in plane y=0 (default=false). // Activa simetria en el plano y=0 (default=false)
  bool Stable;
  ...
  //-Variables for periodic conditions. / Variables para condiciones periodicas
  byte PeriActive;
  ...
  TpFtMode FtMode;               ///<Defines interaction mode for floatings and boundaries. / Define el modo de interaccion para floatings y boundaries
  ...
  bool UseDEM;         ///<Use DEM for boundary collisions. // Use DEM para colisiones fronterizas.
