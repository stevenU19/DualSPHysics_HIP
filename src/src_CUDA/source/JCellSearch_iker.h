...
/// Implements CUDA device functions for neighborhood search. / Implementa las funciones del dispositivo CUDA para la búsqueda de vecindades.
namespace cunsearch{
...
/// Devuelve rango de particulas limite para busqueda de vecinos.
//------------------------------------------------------------------------------
